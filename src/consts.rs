...
pub fn job_name_table() -> HashMap<JobId, String> {
    ...
    table.insert(JobId::KnightH, encoding::all::WINDOWS_1252.decode(&[0xB7, 0xCE, 0xB5, 0xE5, 0xB3, 0xAA, 0xC0, 0xCC, 0xC6, 0xAE], DecoderTrap::Strict).unwrap());
    table.insert(JobId::PriestH, encoding::all::WINDOWS_1252.decode(&[0xC7, 0xCF, 0xC0, 0xCC, 0xC7, 0xC1, 0xB8, 0xAE], DecoderTrap::Strict).unwrap());
    table.insert(JobId::WizardH, encoding::all::WINDOWS_1252.decode(&[0xC7, 0xCF, 0xC0, 0xCC, 0xC0, 0xA7, 0xC0, 0xFA, 0xB5, 0xE5], DecoderTrap::Strict).unwrap());
    table.insert(JobId::BlacksmithH, encoding::all::WINDOWS_1252.decode(&[0xC8, 0xAD, 0xC0, 0xCC, 0xC6, 0xAE, 0xBD, 0xBA, 0xB9, 0xCC, 0xBD, 0xBA], DecoderTrap::Strict).unwrap());
    table.insert(JobId::HunterH, encoding::all::WINDOWS_1252.decode(&[0xBD, 0xBA, 0xB3, 0xAA, 0xC0, 0xCC, 0xC6, 0xDB], DecoderTrap::Strict).unwrap());
    table.insert(JobId::AssassinH, encoding::all::WINDOWS_1252.decode(&[0xBE, 0xEE, 0xBD, 0xD8, 0xBD, 0xC5, 0xC5, 0xA9, 0xB7, 0xCE, 0xBD, 0xBA], DecoderTrap::Strict).unwrap());
    table.insert(JobId::Knight2H, encoding::all::WINDOWS_1252.decode(&[0xB7, 0xCE, 0xB5, 0xE5, 0xC6, 0xE4, 0xC4, 0xDA], DecoderTrap::Strict).unwrap());
    table.insert(JobId::CrusaderH, encoding::all::WINDOWS_1252.decode(&[0xC6, 0xC8, 0xB6, 0xF3, 0xB5, 0xF2], DecoderTrap::Strict).unwrap());
    table.insert(JobId::MonkH, encoding::all::WINDOWS_1252.decode(&[0xC3, 0xA8, 0xC7, 0xC7, 0xBF, 0xC2], DecoderTrap::Strict).unwrap());
    table.insert(JobId::SageH, encoding::all::WINDOWS_1252.decode(&[0xC7, 0xC1, 0xB7, 0xCE, 0xC6, 0xE4, 0xBC, 0xAD], DecoderTrap::Strict).unwrap());
    table.insert(JobId::RogueH, encoding::all::WINDOWS_1252.decode(&[0xBD, 0xBA, 0xC5, 0xE4, 0xC4, 0xBF], DecoderTrap::Strict).unwrap());
    table.insert(JobId::AlchemistH, encoding::all::WINDOWS_1252.decode(&[0xC5, 0xA9, 0xB8, 0xAE, 0xBF, 0xA1, 0xC0, 0xCC, 0xC5, 0xCD], DecoderTrap::Strict).unwrap());
    table.insert(JobId::BardH, encoding::all::WINDOWS_1252.decode(&[0xC5, 0xAC, 0xB6, 0xF3, 0xBF, 0xEE], DecoderTrap::Strict).unwrap());
    table.insert(JobId::DancerH, encoding::all::WINDOWS_1252.decode(&[0xC1, 0xFD, 0xBD, 0xC3], DecoderTrap::Strict).unwrap());
    table.insert(JobId::Crusader2H, encoding::all::WINDOWS_1252.decode(&[0xC6, 0xE4, 0xC4, 0xDA, 0xC6, 0xC8, 0xB6, 0xF3, 0xB5, 0xF2], DecoderTrap::Strict).unwrap());

    table.insert(JobId::RuneKnight, encoding::all::WINDOWS_1252.decode(&[0xB7, 0xE9, 0xB3, 0xAA, 0xC0, 0xCC, 0xC6, 0xAE], DecoderTrap::Strict).unwrap());
    ...
    table.insert(JobId::GuillotineCross, encoding::all::WINDOWS_1252.decode(&[0xB1, 0xE6, 0xB7, 0xCE, 0xC6, 0xBE, 0xC5, 0xA9, 0xB7, 0xCE, 0xBD, 0xBA], DecoderTrap::Strict).unwrap());

    table.insert(JobId::RoyalGuard, encoding::all::WINDOWS_1252.decode(&[0xB0, 0xA1, 0xB5, 0xE5], DecoderTrap::Strict).unwrap());
    ...
    table.insert(JobId::ShadowChaser, encoding::all::WINDOWS_1252.decode(&[0xBD, 0xA6, 0xB5, 0xB5, 0xBF, 0xEC, 0xC3, 0xBC, 0xC0, 0xCC, 0xBC, 0xAD], DecoderTrap::Strict).unwrap());

    table.insert(JobId::RuneKnight2, encoding::all::WINDOWS_1252.decode(&[0xB7, 0xE9, 0xB3, 0xAA, 0xC0, 0xCC, 0xC6, 0xAE, 0xBB, 0xDA, 0xB6, 0xEC], DecoderTrap::Strict).unwrap());
    table.insert(JobId::RoyalGuard2, encoding::all::WINDOWS_1252.decode(&[0xB1, 0xD7, 0xB8, 0xAE, 0xC6, 0xF9, 0xB0, 0xA1, 0xB5, 0xE5], DecoderTrap::Strict).unwrap());
