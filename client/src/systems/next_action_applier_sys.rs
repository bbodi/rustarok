use crate::components::char::{
    CastingSkillData, CharState, CharacterStateComponent, SpriteRenderDescriptorComponent,
};
...
impl<'a> System<'a> for UpdateCharSpriteBasedOnStateSystem {
    ...
    fn run(&mut self, (char_state_storage, mut sprite_storage, sys_vars, time): Self::SystemData) {
...
impl<'a> System<'a> for SavePreviousCharStateSystem {
    ...
    fn run(&mut self, (entities, mut char_state_storage, time, mut events): Self::SystemData) {
