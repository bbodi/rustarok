...
class ModelRenderer(gl: WebGL2RenderingContext) {

    private val model_gl_program = load_model_shader(gl)

    fun render_models(gl: WebGL2RenderingContext, commands: ArrayList<RenderCommand.Model3D>,
                      ground_command: RenderCommand.Ground3D,
        ...
        for (command in commands) {
            ...
            for (node in model.nodes) {
                ...
                gl.vertexAttribPointer(model_gl_program.a_vertex_normal,
                                       3,
    ...
    private fun load_model_shader(gl: WebGL2RenderingContext): ModelShader {
...
void main() {
    ...
    private data class ModelShader(val program: WebGLProgram,
